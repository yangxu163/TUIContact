...
- (UISearchBar *)searchBar
{
    if (_searchBar == nil) {
        ...
        [[UIBarButtonItem appearanceWhenContainedInInstancesOfClasses:@[[UISearchBar class]]] setTitle:TUIKitLocalizableString(Cancel)];
        [[UIBarButtonItem appearanceWhenContainedInInstancesOfClasses:@[[UISearchBar class]]] setTitleTextAttributes:@{NSForegroundColorAttributeName: [UIColor colorWithHex:@"0x333333"]} forState:(UIControlStateNormal)];
    }
    return _searchBar;
}

...
- (void)fillWithData:(TUICommonPendencyCellData *)pendencyData {
    ...
    if (pendencyData.isAccepted) {
        ...
        self.agreeButton.backgroundColor = TUICoreDynamicColor(@"primary_theme_color", @"#03BDAC");
    }
    ...
    if (pendencyData.isRejected) {
        ...
        [self.rejectButton setTitleColor:TUICoreDynamicColor(@"primary_theme_color", @"#03BDAC") forState:UIControlStateNormal];
    }
